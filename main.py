...
async def on_message(message):
  ...
  if (message.guild.id == 932135849838129152 and (message.content == '"' or message.content == '-' or message.content == '0' or message.content == '=' or ("'-'" in message.content and "c." not in message.content and message.author.id != 801983327023398912))):
