...
async def on_message(message):
    ...
    if message.content == "<@607583934527569920>" and message.channel.id == 845216463237021706:
        await message.channel.send(
            "If you ping the owner one more time he won't help you with your question."
        )
    ...
    if ("@everyone" in message.content or "<@&800718299167064064>"
        ...
        await message.channel.send(
            "How fucking narcissistic do you have to be to ping hundreds of people and disrupt their lives just for you? You're lucky the everyone role you just pinged was fake otherwise you probably would have annoyed a lot of people."
        )
